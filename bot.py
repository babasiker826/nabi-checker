...
def iyzico():
    ...
    yapimci = "🕸️ℙℝ𝕆𝔾ℝ𝔸𝕄𝕄𝔼ℝ𖤍:@sukazatkinis"

    if "3-D Secure" in iyz_res.text:
        return f"{cc} {ay} {cvv} -> 𝕂𝕒𝕣𝕥 𝔻𝕠𝕘𝕣𝕦𝕝𝕒𝕟𝕕𝕚, 𝕂𝕒𝕣𝕥 𝔾𝕖𝕔𝕖𝕣𝕝𝕚𝕕𝕚𝕣 𝔸ℙ𝕚 𝕋𝕒𝕣𝕒𝕗𝕚𝕟𝕕𝕒𝕟 𝔻𝕠𝕘𝕣𝕦𝕝𝕒𝕟𝕕𝕚 𓆏 | {yapimci}"
    else:
        ...
        return f"{cc} {ay} {cvv} -> 𝕂𝔸𝕣𝕥 𝕊𝕒𝕙𝕥𝕖 𝔾𝕖𝕔𝕖𝕣𝕤𝕚𝕫𝕕𝕚𝕣𓆩𓆪 | {yapimci}"
